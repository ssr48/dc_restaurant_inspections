...
potential_inspection_ids_dataframe = pd.read_csv("full_potential_inspection_ids.csv")
...
if len(ids_to_cache) > 0:
    ...
    for i, chunk in enumerate(chunks):
        ...
        potential_new_inspection_ids_dataframe["appears_real"] = None
        ...
        potential_inspection_ids_dataframe.to_csv("full_potential_inspection_ids.csv", index=False)
