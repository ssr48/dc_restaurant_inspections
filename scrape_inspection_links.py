...
if not Path("scraped_inspection_links.csv").exists():
    ...
    existing_scraped_links_dataframe = pd.read_csv("scraped_inspection_links.csv")
    ...
    merged_scraped_links_dataframe.to_csv("scraped_inspection_links.csv", index=False)
